...
def create_app():
    ...
    from .api.plan_routes import plan_bp
    ...
    with app.app_context():
        ...
        app.forecast_service = ForecastService()
        app.vector_store = VectorStoreService(CONFIG)
        app.image_agent = ImageRecognitionAgent(model_path=CONFIG.MODEL_PATH, class_names=CONFIG.CLASS_NAMES, storage_folder=CONFIG.STORAGE_FOLDER)
