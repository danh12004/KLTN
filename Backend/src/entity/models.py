...
class AnalysisSession(db.Model):
    ...
    suggested_plan_json = db.Column(db.Text, nullable=True) 
    
    plan_type = db.Column(db.String(50), nullable=False, default='treatment')
    status = db.Column(db.String(50), nullable=False, default='Chờ xác nhận')
    executed_payload_json = db.Column(db.Text, nullable=True)
    
    follow_up_time = db.Column(db.DateTime, nullable=True) 
    follow_up_status = db.Column(db.String(50), nullable=False, default='Không áp dụng')
